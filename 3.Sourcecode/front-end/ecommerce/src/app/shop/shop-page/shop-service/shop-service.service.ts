...
export class ShopServiceService {
  ...
  private URL_GET = environment.API_LOCAL+ '/public/shop-page'
  ...
  public findProductForShop(res: PageRequest): Observable<BaseReponse<ProductsResponse>>{
    return this.http.post<BaseReponse<ProductsResponse>>(this.URL_GET,res);
  }
}
